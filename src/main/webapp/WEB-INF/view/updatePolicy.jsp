		...
		<div class="container py-5">
		    <div class="row">
		        ...
		        <div class="col-md-10 mx-auto">
		            ...
		            <form:input type="hidden" path="policyId" />
		                ...
		                <div class="form-group row" id="topUpField" style="display: none;">
		                    ...
		                    <div class="col-sm-6">
					        	<div id="addedCover" style="display: none;">
		                ...
		                <div class="form-group row">
		                    <div class="col-sm-6">
		                        ...
		                        <form:input type="text" class="form-control" path="paymentTenure" placeholder="Payment Tenure" required="required"/>
		                    </div>
		                    <div class="col-sm-6">
		                        <label for="inputFirstname">Payment Mode</label>
		                    	<form:select path="paymentMode" class="form-control" required="required">
		                        	<option value="none">--Select--</option>
		                ...
		                <div class="form-group row">
		                    ...
		                    <div class="col-sm-6">
		                        ...
		                        <form:input type="date" class="form-control" path="clientDoB" min="2000-01-01" max="2023-02-03" placeholder="Date of Birth" required="required" />
		                    </div>
		                </div>
		                <div class="form-group row">
		                    <div class="col-sm-6">
		                ...
		                <div class="form-group row">
		                    <div class="col-sm-6">
		                        ...
		                        <form:radiobutton path="consumeTobacco" value="Yes" name="consumeTobacco" required="required" />
		                        <label style="padding-left: 20px;"for="No">No</label>
		                        <form:radiobutton path="consumeTobacco" value="No" name="consumeTobacco" required="required" />
		                    </div>
		                    <div class="col-sm-6">
		                ...
		                <div class="form-group row">
		                    <div class="col-sm-6">
		                        ...
		                        <form:input type="text" class="form-control" path="lifeCoverAmount" placeholder="Life Cover Amount" required="required" />
		                    </div>
		                    <div class="col-sm-6">
